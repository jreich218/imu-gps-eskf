...
::: {.cpp-api-signature-block}
<div class="cpp-api-signature-source"><a href="https://github.com/jreich218/imu-gps-eskf/blob/main/include/initialization.hpp#L76">source</a></div>
...
### `TraceStartupInitialization` {#trace-startup-initialization}
...
::: {.cpp-api-signature-block}
<div class="cpp-api-signature-source"><a href="https://github.com/jreich218/imu-gps-eskf/blob/main/include/initialization.hpp#L94">source</a></div>
...
The returned trace records the quantities the startup code computes for each
tested GPS prefix. If startup succeeds, the trace also includes the resulting
handoff state.
